            ...
            <table class="table table-primary">
                <thead>
                    <tr>
                        ...
                        <th scope="col">{{ __('words.slug') }}</th>
                        <th scope="col">{{ __('validation.attributes.edit') }}</th>
                    </tr>
                </thead>
                <tbody>
                    @foreach ($categories as $category)
                        <tr class="">
                            ...
                            <td>{{ $category->slug }}</td>
                            <td><a href="{{ route('test.language.edit',$category->id ) }}" class="btn btn-info">{{ __('validation.attributes.edit') }}</a></td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
