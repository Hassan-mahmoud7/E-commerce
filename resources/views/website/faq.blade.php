    ...
    <section class="blog about-blog">
        <div class="container">
            <div class="blog-bradcrum">
                ...
                <span><a href="javascript:void(0)">{{ __('website.faq') }}</a></span>
            </div>
            <div class="blog-heading about-heading">
                <h1 class="heading">{{ __('website.faqs') }}</h1>
            </div>
        </div>
    </section>
            ...
            <div class="row gy-5">
                ...
                <div class="col-lg-6">
                    <div class="faq-accordion accordion accordion-flush" id="accordionFlushExample" data-aos="fade-right">
                        <h5>{{ __('website.frequently_asked_questions') }}</h5>
                        @forelse ($faqs as $faq)
                        ...
                        <div class="faq-item accordion-item">
                            <h2 class="accordion-header">
                                <main class="faq-button accordion-button collapsed" style="color: #ae1c9a;">
                                    <span class="faq-heading ">
                                        {{ __('website.no_faqs_available') }}
                                    </span>
                                </main>
                            </h2>
                        </div>
...
@push('js')
    <script>
        document.addEventListener('livewire:init', () => {
            Livewire.on('faq-question-created', (event) => {
                Swal.fire({
            ...
            Livewire.on('faq-question-failed', (event) => {
                Swal.fire({
