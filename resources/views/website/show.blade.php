    ...
    <section class="product product-info">
        <div class="container">
            <div class="blog-bradcrum">
                ...
                <span><a href="..........">{{ __('website.shop') }}</a></span>
                <span class="devider">/</span>
                                ...
                                <div class="swiper-wrapper">
                                    @foreach ($product->images as $item)
                                        <div class="swiper-slide slider-top-img">
                                            <img src="{{ asset('assets/img/uploads/products/' . $item->file_name) }}"
                                                alt="{{ $product->name }}">
                                        </div>
                                    @endforeach
                                </div>
                    ...
                    <div class="col-md-6">
                        <div class="product-info-content">
                            ...
                            <div class="ratings">
                                ...
                                <span class="text">{{ $product->productPreviews->count() }} Reviews</span>
                            </div>
                            {{-- price && qunatity && vraiants --}}
                            @livewire('website.product-details', ['product' => $product])
                           
                            {{-- wishlist --}}
                            <div class="product-quantity">
                            @livewire('website.wishlist.wishlist', ['product' => $product])
                            </div>
                            <hr>
                                    ...
                                    <div class="login-section account-section modal-main">
                                        <div class="review-form">
                                            <div class="review-content">
                                                ...
                                                <div class="close-btn">
                                                    <img src="{{ asset('assets/website') }}/assets/images/homepage-one/close-btn.png"
                                            ...
                                            <div class="login-btn text-center">
                                                <a href="#" onclick="modalAction('.action')"
                                                    class="shop-btn">Submit
                                                    Report</a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="product-share">
                                ...
                                <div class="social-icons">
                                    ...
                                    <a href="https://www.pinterest.com/pin/create/button/?url={{ $shareUrl }}"
                                    ...
                                    <a href="https://www.twitter.com/intent/tweet.php?u={{ $shareUrl }}"
                                        target="_blank" title="twitter(x)" rel="noopener">
                                        <span class="twitter">
                ...
                <nav>
                    <div class="nav nav-tabs nav-item" id="nav-tab" role="tablist">
                        <button class="nav-link active" id="nav-home-tab" data-bs-toggle="tab"
                            ...
                            aria-selected="true">{{ __('website.description') }}</button>
                        <button class="nav-link" id="nav-review-tab" data-bs-toggle="tab" data-bs-target="#nav-review"
                            ...
                            aria-selected="false">{{ __('website.reviews') }}</button>
                    </div>
                </nav>
                                ...
                                <div class="review-wrapper">
                                    <div class="wrapper">
                                        <div class="wrapper-aurthor">
                                            <div class="wrapper-info">
                                                ...
                                                <div class="author-details">
                                                    ...
                                                    <p>{{ $item->user->country->name }}, {{ $item->user->city->name }}
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="ratings">
                                        ...
                                        <div class="wrapper-description">
                                            <p class="wrapper-details">{{ $item->comment }}</p>
                                        </div>
                                    </div>
                                </div>
                            @empty
                                <div>
                                    <p class="text-info">{{ __('website.no_reviews_yet') }}</p>
                                </div>
                            @endforelse
                        </div>
                    </div>
    ...
    <section class="product weekly-sale product-weekly footer-padding">
        <div class="container">
            <div class="section-title">
                <h5>{{ __('website.related_product') }}</h5>
                <a href="{{ route('website.products.related', $product->slug) }}"
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="product-wrapper" data-aos="fade-up">
                                <div class="product-img">
                                    <img src="{{ asset('assets/img/uploads/products/' . $product->images->first()->file_name) }}"
                                        alt="{{ $product->name }}">
                                    <div class="product-cart-items">
                                        ...
                                        <a href="javascript:void(0)" class="favourite cart-item">
                                            <span>
                                                <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <div class="price">
                                            @if ($product->has_variants == 0)
                                                @if ($product->has_discount == 0)
                                                    <span
                                                        class="new-price">{{ number_format($product->price, 2) . ' ' . __('website.egp') }}</span>
                                                @else
                                                    <span
                                                        class="price-cut">{{ number_format($product->price, 2) . ' ' . __('website.egp') }}</span>
                                                    <span
                                                        class="new-price">{{ $product->getPriceAfterDiscount() . ' ' . __('website.egp') }}</span>
                                                @endif
                                            @else
                                ...
                                <div class="product-cart-btn">
                                    <a href="{{ route('website.products.show', $product->slug) }}"
                                        class="product-btn">{{ __('website.view_details') }}</a>
                                </div>
                            </div>
                        </div>
                    @endforeach
...
@push('js')
    <script>
        document.addEventListener('livewire:init', () => {
            Livewire.on('addedToWishlist', (event) => {
                Swal.fire({
            ...
            Livewire.on('successMessage', (event) => {
                Swal.fire({
                    title: "{{ __('website.success') }}",
                    text: event,
                    icon: "success",
            ...
            Livewire.on('errorMessage', (event) => {
                Swal.fire({
