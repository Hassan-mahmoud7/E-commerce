...
@section('content')
    ...
    <section class="product-category">
        <div class="container">
            <div class="section-title">
                ...
                <a href="{{ route('website.category.index') }}" class="view">{{ __('website.view_all') }}</a>
            </div>
            <div class="category-section">
                @forelse ($someCategories as $category)
                    <div class="product-wrapper" data-aos="fade-right" data-aos-duration="100">
                        <div class="wrapper-img">
                            <img loading="lazy" src="{{ asset($category->image) }}" alt="{{ asset($category->name) }}">
                        </div>
                        <div class="wrapper-info">
                            <a href="{{ route('website.category.products', $category->slug) }}"
                                class="wrapper-details">{{ $category->name }}</a>
                        </div>
                    </div>
    ...
    <section class="product brand" data-aos="fade-up">
        <div class="container">
            <div class="section-title">
                <h5>{{ __('website.brand_of_prodcuts') }}</h5>
                <a href="{{ route('website.brand.index') }}" class="view">{{ __('website.view_all') }}</a>
            </div>
    ...
    {{-- new arrivals --}}
    @if ($homePageProducts['newArrivals']->count() > 0)

        <section class="product arrival">
            <div class="container">
                <div class="section-title">
                    <h5>{{ __('website.new_arrivals') }}</h5>
                    <a href="{{ route('website.products.by.type','new-arrivals') }}" class="view">{{ __('website.view_all') }}</a>
                </div>
                <div class="arrival-section">
                    <div class="row g-5">
                        @foreach ($homePageProducts['newArrivals'] as $product)
                            <div class="col-lg-3 col-sm-6">
                                <div class="product-wrapper" data-aos="fade-up">
                                    <div class="product-img">
                                        <img loading="lazy"
                                            src="{{ asset('assets/img/uploads/products/' . $product->images->first()->file_name) }}"
                                            alt="{{ $product->name }}">
                                    ...
                                    <div class="position-absolute top-0 start-0 text-white px-2 py-1 m-2 rounded"
                                        style="background-color: #ae1c9a;">
                                        {{ $product->brand->name }}
                                    </div>
        ...
        <section class="product flash-sale">
            <div class="container">
                <div class="section-title">
                    ...
                    <a href="{{ route('website.products.by.type','flash-sale-with-timer') }}" class="view">{{ __('website.view_all') }}</a>
                </div>
                ...
                <div class="row g-5">
                    <div class="col-lg-4 col-md-6">
                        <div class="product-wrapper" data-aos="fade-right">
                            <div class="product-img">
                                <img loading="lazy"
                                    src="{{ asset('assets/website') }}/assets/images/homepage-one/product-img/product-img-5.webp"
                                    alt="product-img">
                                <div class="product-cart-items">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="product-wrapper" data-aos="fade-right">
                            <div class="product-img">
                                <img loading="lazy"
                                    src="{{ asset('assets/website') }}/assets/images/homepage-one/product-img/product-img-3.webp"
                                    alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="product-wrapper" data-aos="fade-right">
                            <div class="product-img">
                                <img loading="lazy"
                                    src="{{ asset('assets/website') }}/assets/images/homepage-one/product-img/product-img-6.webp"
                                    alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="product-wrapper" data-aos="fade-right">
                            <div class="product-img">
                                <img loading="lazy"
                                    src="{{ asset('assets/website') }}/assets/images/homepage-one/product-img/product-img-7.webp"
                                    alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="product-wrapper" data-aos="fade-right">
                            <div class="product-img">
                                <img loading="lazy"
                                    src="{{ asset('assets/website') }}/assets/images/homepage-one/product-img/product-img-8.webp"
                                    alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="product-wrapper" data-aos="fade-right">
                            <div class="product-img">
                                <img loading="lazy"
                                    src="{{ asset('assets/website') }}/assets/images/homepage-one/product-img/product-img-10.webp"
                                    alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="product-wrapper" data-aos="fade-up">
                            <div class="product-img">
                                <img loading="lazy"
                                    src="{{ asset('assets/website') }}/assets/images/homepage-one/product-img/product-img-9.webp"
                                    alt="product-img">
                                <div class="product-cart-items">
                                    <a href="#" class="cart cart-item">
                                        <span>
    ...
    @if ($homePageProducts['flashProducts']->count() > 0)
        <section class="product best-product">
            <div class="container">
                <div class="section-title">
                    <h5>{{ __('website.flash_sale') }}</h5>
                    <a href="{{ route('website.products.by.type','flash-sale') }}" class="view">{{ __('website.view_all') }}</a>
                </div>
