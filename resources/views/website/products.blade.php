        ...
        <section class="blog about-blog">
            <div class="container">
                <div class="blog-bradcrum">
                    ...
                    <span><a href="javascript:void(0)">{{ __('website.product') }}</a></span>
                </div>
                <div class="blog-heading about-heading">
                    <h1 class="heading">{{ __('website.products') }}</h1>
                </div>
            </div>
        </section>
        
        {{-- products --}}
        <section class="product product-sidebar @if(isset($flash_timer)) flash-sale @endif footer-padding">
            <div class="container">
                <div class="row g-5">
                    {{-- <div class="col-lg-3">
             ...
             @if (isset($flash_timer))
                <div class="section-title mt-5">
                    <h5>{{ __('website.flash_sale') }}</h5>
                    <div class="countdown-section m-auto">
        ...
        <section class="blog about-blog footer-padding">
            <div class="container">
                <div class="blog-bradcrum">
                    <span><a href="{{ route('website.home') }}">{{ __('website.home') }}</a></span>
                    <span class="devider">/</span>
                    <span><a href="#">{{ __('website.product') }}</a></span>
                </div>
