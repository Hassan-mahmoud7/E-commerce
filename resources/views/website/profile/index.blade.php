...
@section('title', __('website.user_profile'))
@section('content')
            ...
            <div class="user-profile-section">
                ...
                <div class="user-dashboard">
                    <div class="nav nav-item nav-pills  me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        ...
                        <div class="nav-link">
                            <form action="{{ route('website.logout') }}" method="post" class="d-inline">
                                @csrf
                                <span>
                                        ...
                                        <div class="seller-info">
                                            ...
                                            <div class="info-list">
                                                ...
                                                <div class="info-details">
                                                    ...
                                                    <p><a href="https://quomodothemes.website/cdn-cgi/l/email-protection"
                                                            class="__cf_email__"
                                                            data-cfemail="791d1c14161c14181015391e14181015571a1614">[email&#160;protected]</a>
                                                    </p>
                                                    <p>023 434 54354</p>
                                                    <p>Haydarabad, Rord 34</p>
                                                    <p>3454</p>
                                        ...
                                        <div class="seller-info">
                                            ...
                                            <div class="info-list">
                                                ...
                                                <div class="info-details">
                                                    ...
                                                    <p><a href="https://quomodothemes.website/cdn-cgi/l/email-protection"
                                                            class="__cf_email__"
                                                            data-cfemail="ec8889818389818d8580ac8b818d8580c28f8381">[email&#160;protected]</a>
                                                    </p>
                                                    <p>023 434 54354</p>
                                                    <p>Haydarabad, Rord 34</p>
                                                    <p>3454</p>
