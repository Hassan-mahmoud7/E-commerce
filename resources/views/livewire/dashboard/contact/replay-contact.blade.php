            ...
            <div class="modal-content shadow-lg">
                <div class="modal-header bg-primary text-white">
                    ...
                    <h5 class="modal-title font-weight-bold">
                        <i class="fas fa-envelope"></i> {{ __('dashboard.contact_replay') }}
                    </h5>
                ...
                <div class="modal-body">
                    <form wire:submit.prevent="replayContact" class="form">
                        ...
                        <div class="form-group">
                            <label for="contactSubject"><i class="fas fa-tag"></i> {{ __('dashboard.contact_subject') }}</label>
                            <input readonly wire:model="subject" id="contactSubject" class="form-control bg-light border-0" type="text">
                        </div>

                        <div class="form-group">
                            <label for="replayMessage"><i class="fas fa-comment-dots"></i> {{ __('dashboard.contact_message') }}</label>
