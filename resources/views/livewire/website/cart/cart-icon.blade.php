    ...
    <a href="{{ route('website.cart') }}" class="cart-item">
        <span>
            <svg width="35" height="28" viewBox="0 0 35 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <text x="26.8" y="12" text-anchor="middle" fill="#F9FFFB" font-size="12" font-family="Arial"
                    font-weight="bold">
                    {{ $cartCount }}
                </text>
            </svg>
            ...
            <div class="cart-submenu">
                        ...
                        <div class="wrapper">
                            <div class="wrapper-item">
                                ...
                                <div class="wrapper-content">
                                    ...
                                    <div class="price">
                                        <p class="new-price">{{ $item->price }} {{ __('website.egp') }}</p>

                                    </div>
                                </div>
                            </div>
                            <span wire:click="removeProductFromCart({{ $item->id }})" class="close-btn">
                ...
                <div class="cart-wrapper-section">
                    ...
                    <div class="wrapper-subtotal">
                        ...
                        <h5 class="wrapper-title">{{ $total }} {{ __('website.egp') }}</h5>
                    </div>
                    <div class="cart-btn">
