                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="name" id="userinput1"
                                                            ...
                                                            placeholder="{{ __('dashboard.admin_name_en') }}" value="{{ $admin->name }}">
                                                        @error('name')
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="email" id="userinput25"
                                                            ...
                                                            placeholder="{{ __('dashboard.admin_name') }}" value="{{ $admin->email }}">
                                                        @error('email')
                                                            <strong class="invalid-feedback"> {{ $message }}</strong>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group position-relative">
                                                        ...
                                                        <select name="status" id="selectColor1" class="form-control border-warning @error('status') is-invalid  @enderror">
                                                            ...
                                                            <option @selected($admin->status == 0) value="0">{{ __('dashboard.not_active') }}</option>
                                                        </select>
                                                        @error('status')
                                                            <strong class="invalid-feedback"> {{ $message }}</strong>
                                                        @enderror
