                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title"><b>{{ __('dashboard.countries') }}</b></h4>
                        ...
                        <div class="card-content collapse show">
                            {{-- <div class="card-body">
                                <a href="{{ route('dashboard.countrys.create') }}" class="btn btn-success px-2 round btn-glow"> <i class="ft-edit"></i> {{ __('dashboard.create_country') }}</a>
                            </div> --}}
                            <div class="card-content collapse show">
                                ...
                                <table class="table table-striped table-bordered zero-configuration">
                                    <thead>
                                        <tr>
                                            <th scope="col">#</th>
                                            <th scope="col">{{ __('dashboard.country_name') }}</th>
                                            <th scope="col">{{ __('dashboard.country_phone_code') }}</th>
                                            <th scope="col">{{ __('dashboard.country_count_governorates') }}</th>
                                            <th scope="col">{{ __('dashboard.count_of_users') }}</th>
                                            <th scope="col">{{ __('dashboard.country_status') }}</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a class="" href="{{ route('dashboard.governorates.by.country', $country->id) }}">{{ $country->name }} <i class="flag-icon flag-icon-{{ $country->flag_code }}"></i></a></td>
                                            <td><div class="card-body p-0">
                                                <fieldset class="form-group position-relative has-icon-left">
                                                  <input type="text" disabled class="form-control" id="iconLeft" placeholder="{{ $country->phone_code }}">
                                            ...
                                            <td>   
                                             ...
                                             @if ($country->status == 1 ) checked @endif
                                             />                                                             
                                             </td>
                                        </tr>             
                                        @empty
