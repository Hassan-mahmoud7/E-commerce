                    ...
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"><a href="#">{{ __('dashboard.edit_category') }}</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="name[ar]" id="userinput1"
                                                            ...
                                                            placeholder="{{ __('dashboard.category_name_ar') }}" value="{{ $category->getTranslation('name' , 'ar') }}">
                                                        @error('name.ar')
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="name[en]" id="userinput25"
                                                            ...
                                                            placeholder="{{ __('dashboard.category_name_en') }}" value="{{ $category->getTranslation('name' , 'en') }}">
                                                        @error('name.en')
                                                            <strong class="invalid-feedback"> {{ $message }}</strong>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="form-group col-12 mb-2">
                                                    ...
                                                    <div class="input-group">
                                                      <div class="d-inline-block custom-control custom-radio mr-1">
                                                        <input type="radio" name="status" @checked($category->status == 1) class="custom-control-input" id="on" value="1">
                                                        <label class="custom-control-label" for="on">{{ __('dashboard.active') }}</label>
                                                      </div>
                                                      <div class="d-inline-block custom-control custom-radio">
                                                        <input type="radio" name="status" @checked($category->status == 0 ) class="custom-control-input" id="off" value="0">
                                                        <label class="custom-control-label" for="off">{{ __('dashboard.not_active') }}</label>
                                                      </div>
                                                    </div>
                                                  </div>
                                                </div>
