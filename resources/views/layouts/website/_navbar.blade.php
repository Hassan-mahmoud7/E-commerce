                        ...
                        <div class="cart-submenu">
                            <div class="cart-wrapper-item">
                                <div class="wrapper">
                                    <div class="wrapper-item">
                                        <div class="wrapper-img">
                                            <img src="{{ asset('assets/website/assets/images/homepage-one/product-img/product-img-1.webp') }}') }}"
                                                alt="img">
                                        </div>
                                ...
                                <div class="wrapper">
                                    <div class="wrapper-item">
                                        <div class="wrapper-img">
                                            <img src="{{ asset('assets/website/assets/images/homepage-one/product-img/product-img-2.webp') }}') }}"
                                                alt="img">
                                        </div>
                                        <div class="wrapper-content">
                                ...
                                <div class="wrapper">
                                    <div class="wrapper-item">
                                        <div class="wrapper-img">
                                            <img src="{{ asset('assets/website/assets/images/homepage-one/product-img/product-img-3.webp') }}"
                                                alt="img">
                                        </div>
                                        <div class="wrapper-content">
                                ...
                                <div class="wrapper">
                                    <div class="wrapper-item">
                                        <div class="wrapper-img">
                                            <img src="{{ asset('assets/website/assets/images/homepage-one/product-img/product-img-4.webp') }}"
                                                alt="img">
                                        </div>
                                        <div class="wrapper-content">
                                ...
                                <div class="dropdown-item d-flex justify-content-between align-items-center">
                                    <div class="dropdown-list-item d-flex">
                                        <span class="dropdown-img">
                                            <img src="{{ asset('assets/website/assets/images/homepage-one/category-img/dresses.webp') }}"
                                                alt="dress">
                                        </span>
                        ...
                        <li class="category-list-item">
                            <a href="product-sidebar.html">
                                <div class="dropdown-item d-flex justify-content-between align-items-center">
                                    <div class="dropdown-list-item d-flex">
                                        <span class="dropdown-img">
                                            <img src="{{ asset('assets/website/assets/images/homepage-one/category-img/sweaters.webp') }}"
                                                alt="sweaters">
                                        </span>
                                        <span class="dropdown-text">
                                            Sweaters
                        ...
                        <li class="category-list-item">
                            <a href="product-sidebar.html">
                                <div class="dropdown-item d-flex justify-content-between align-items-center">
                                    <div class="dropdown-list-item d-flex">
                                        <span class="dropdown-img">
                                            <img src="{{ asset('assets/website/assets/images/homepage-one/category-img/shoes.webp') }}"
                                                alt="sweaters">
                                        </span>
                                        <span class="dropdown-text">
                                            Boots
                        ...
                        <li class="category-list-item">
                            <a href="product-sidebar.html">
                                <div class="dropdown-item d-flex justify-content-between align-items-center">
                                    <div class="dropdown-list-item d-flex">
                                        <span class="dropdown-img">
                                            <img src="{{ asset('assets/website/assets/images/homepage-one/category-img/sneakers.webp') }}"
                                                alt="sneakers">
                                        </span>
                                        <span class="dropdown-text">
                                            Sneakers
                        ...
                        <li class="category-list-item">
                            <a href="product-sidebar.html">
                                <div class="dropdown-item d-flex justify-content-between align-items-center">
                                    <div class="dropdown-list-item d-flex">
                                        <span class="dropdown-img">
                                            <img src="{{ asset('assets/website/assets/images/homepage-one/category-img/watch.webp') }}"
                                                alt="watch">
                                        </span>
                                        <span class="dropdown-text">
                                            Watches
                        ...
                        <li class="category-list-item">
                            <a href="product-sidebar.html">
                                <div class="dropdown-item d-flex justify-content-between align-items-center">
                                    <div class="dropdown-list-item d-flex">
                                        <span class="dropdown-img">
                                            <img src="{{ asset('assets/website/assets/images/homepage-one/category-img/glass.webp') }}"
                                                alt="glass">
                                        </span>
                                        <span class="dropdown-text">
                                            Sunglasses
