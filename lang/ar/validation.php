...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'question.ar'           => 'السؤال باللغة العربية',
        'question.en'           => 'السؤال باللغة الانجليزية',
        ...
        'quantity'              => 'الكمية',
        'desc.en'               => 'وصف بالعربى',
        'desc.ar'               => 'وصف بالانجليزى',
        'samll_desc.en'         => 'وصف الصغير بالانجليزى',
        'samll_desc.ar'         => 'وصف الصغير بالعربى',
        'title.en'            => 'العنوان بالانجليزى',
        'title.ar'            => 'العنوان بالعربى',
        'content.en'          => 'المحتوى بالانجليزى',
        'content.ar'          => 'المحتوى بالعربى',
